...
abstract class CubePlayerPaperWrapper(val wrapperPlayer: Player) : Player {
    ...
    override fun banIp(
        ...
        source: String?,
        kickPlayer: Boolean
    ): BanEntry<InetAddress?>? = wrapperPlayer.banIp(reason, expires, source, kickPlayer)
    ...
    override fun banIp(
        ...
        source: String?,
        kickPlayer: Boolean
    ): BanEntry<InetAddress?>? = wrapperPlayer.banIp(reason, duration, source, kickPlayer)
    ...
    override fun playSound(
        ...
        volume: Float,
        pitch: Float
    ) = wrapperPlayer.playSound(location, sound, volume, pitch)
    ...
    override fun playSound(
        ...
        volume: Float,
        pitch: Float
    ) = wrapperPlayer.playSound(location, sound, category, volume, pitch)
    ...
    override fun playSound(
        ...
        pitch: Float,
        seed: Long
    ) = wrapperPlayer.playSound(location, sound, category, volume, pitch, seed)
    ...
    override fun playSound(
        ...
        volume: Float,
        pitch: Float
    ) = wrapperPlayer.playSound(entity, sound, volume, pitch)
    ...
    override fun playSound(
        ...
        volume: Float,
        pitch: Float
    ) = wrapperPlayer.playSound(entity, sound, category, volume, pitch)
    ...
    override fun playSound(
        ...
        pitch: Float,
        seed: Long
    ) = wrapperPlayer.playSound(entity, sound, category, volume, pitch, seed)
    ...
    ) = wrapperPlayer.sendBlockChanges(blocks, suppressLightUpdates)
    ...
    override fun sendEquipmentChange(
        ...
        slot: EquipmentSlot,
        item: ItemStack?
    ) = wrapperPlayer.sendEquipmentChange(entity, slot, item)

    override fun sendEquipmentChange(
        entity: LivingEntity,
        items: Map<EquipmentSlot?, ItemStack?>
    ) = wrapperPlayer.sendEquipmentChange(entity, items)
    ...
    override fun sendSignChange(
        ...
        dyeColor: DyeColor
    ) = wrapperPlayer.sendSignChange(loc, lines, dyeColor)
    ...
    ) = wrapperPlayer.sendSignChange(loc, lines, dyeColor, hasGlowingText)
    ...
    override fun sendPotionEffectChange(
        entity: LivingEntity,
        effect: PotionEffect
    ) = wrapperPlayer.sendPotionEffectChange(entity, effect)

    override fun sendPotionEffectChangeRemove(
        entity: LivingEntity,
        type: PotionEffectType
    ) = wrapperPlayer.sendPotionEffectChangeRemove(entity, type)
    ...
    override fun setResourcePack(
        ...
        prompt: String?,
        force: Boolean
    ) = wrapperPlayer.setResourcePack(url, hash, prompt, force)
    ...
    override fun setResourcePack(
        ...
        prompt: String?,
        force: Boolean
    ) = wrapperPlayer.setResourcePack(id, url, hash, prompt, force)
    ...
    override fun addResourcePack(
        ...
        prompt: String?,
        force: Boolean
    ) = wrapperPlayer.addResourcePack(id, url, hash, prompt, force)
    ...
    override fun sendTitle(
        ...
        stay: Int,
        fadeOut: Int
    ) = wrapperPlayer.sendTitle(title, subtitle, fadeIn, stay, fadeOut)
    ...
    override fun spawnParticle(
        ...
        z: Double,
        count: Int
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        count: Int,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, location, count, data)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        count: Int,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, data)
    ...
    override fun spawnParticle(
        ...
        offsetY: Double,
        offsetZ: Double
    ) = wrapperPlayer.spawnParticle(particle, location, count, offsetX, offsetY, offsetZ)
    ...
    override fun spawnParticle(
        ...
        offsetY: Double,
        offsetZ: Double
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        offsetZ: Double,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, location, count, offsetX, offsetY, offsetZ, data)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        offsetZ: Double,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ, data)
    ...
    override fun spawnParticle(
        ...
        offsetZ: Double,
        extra: Double
    ) = wrapperPlayer.spawnParticle(particle, location, count, offsetX, offsetY, offsetZ, extra)
    ...
    override fun spawnParticle(
        ...
        offsetZ: Double,
        extra: Double
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ, extra)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        extra: Double,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, location, count, offsetX, offsetY, offsetZ, extra, data)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        extra: Double,
        data: T?
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ, extra, data)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        data: T?,
        force: Boolean
    ) = wrapperPlayer.spawnParticle(particle, location, count, offsetX, offsetY, offsetZ, extra, data, force)
    ...
    override fun <T : Any?> spawnParticle(
        ...
        data: T?,
        force: Boolean
    ) = wrapperPlayer.spawnParticle(particle, x, y, z, count, offsetX, offsetY, offsetZ, extra, data, force)
    ...
    ) = wrapperPlayer.abandonConversation(conversation, details)
    ...
    override fun ban(
        ...
        expires: Date?,
        source: String?
    ): BanEntry<PlayerProfile?>? = wrapperPlayer.ban(reason, expires, source)
    ...
    override fun ban(
        ...
        duration: Duration?,
        source: String?
    ): BanEntry<PlayerProfile?>? = wrapperPlayer.ban(reason, duration, source)
    ...
    override fun incrementStatistic(
        ...
        material: Material,
        amount: Int
    ) = wrapperPlayer.incrementStatistic(statistic, material, amount)

    override fun decrementStatistic(
        statistic: Statistic,
        material: Material,
        amount: Int
    ) = wrapperPlayer.decrementStatistic(statistic, material, amount)
    ...
    override fun incrementStatistic(
        ...
        amount: Int
    ) = wrapperPlayer.incrementStatistic(statistic, entityType, amount)

    override fun decrementStatistic(
        statistic: Statistic,
        entityType: EntityType,
        amount: Int
    ) = wrapperPlayer.decrementStatistic(statistic, entityType, amount)

    override fun setStatistic(
        statistic: Statistic,
        entityType: EntityType,
        newValue: Int
    ) = wrapperPlayer.setStatistic(statistic, entityType, newValue)
    ...
    ): Boolean = wrapperPlayer.teleport(location, cause)
    ...
    override fun teleport(
        destination: Entity,
        cause: PlayerTeleportEvent.TeleportCause
    ): Boolean = wrapperPlayer.teleport(destination, cause)

    override fun getNearbyEntities(
        x: Double,
        y: Double,
        z: Double
    ): List<Entity?> = wrapperPlayer.getNearbyEntities(x, y, z)
    ...
    override fun setWindowProperty(
        ...
        value: Int
    ): Boolean = wrapperPlayer.setWindowProperty(prop, value)
    ...
    override fun openWorkbench(
        location: Location?,
        force: Boolean
    ): InventoryView? = wrapperPlayer.openWorkbench(location, force)

    override fun openEnchanting(
        location: Location?,
        force: Boolean
    ): InventoryView? = wrapperPlayer.openEnchanting(location, force)
    ...
    override fun openMerchant(
        trader: Villager,
        force: Boolean
    ): InventoryView? = wrapperPlayer.openMerchant(trader, force)

    override fun openMerchant(
        merchant: Merchant,
        force: Boolean
    ): InventoryView? = wrapperPlayer.openMerchant(merchant, force)
    ...
    ) = wrapperPlayer.startRiptideAttack(duration, attackStrength, attackItem)
    ...
    override fun getLineOfSight(
        ...
        maxDistance: Int
    ): List<Block?> = wrapperPlayer.getLineOfSight(transparent, maxDistance)

    override fun getTargetBlock(
        transparent: Set<Material?>?,
        maxDistance: Int
    ): Block = wrapperPlayer.getTargetBlock(transparent, maxDistance)

    override fun getLastTwoTargetBlocks(
        transparent: Set<Material?>?,
        maxDistance: Int
    ): List<Block?> = wrapperPlayer.getLastTwoTargetBlocks(transparent, maxDistance)
    ...
    ): Block? = wrapperPlayer.getTargetBlockExact(maxDistance, fluidCollisionMode)
    ...
    override fun rayTraceBlocks(
        maxDistance: Double,
        fluidCollisionMode: FluidCollisionMode
    ): RayTraceResult? = wrapperPlayer.rayTraceBlocks(maxDistance, fluidCollisionMode)
    ...
    override fun addAttachment(
        ...
        name: String,
        value: Boolean
    ): PermissionAttachment = wrapperPlayer.addAttachment(plugin, name, value)
    ...
    override fun addAttachment(
        ...
        value: Boolean,
        ticks: Int
    ): PermissionAttachment? = wrapperPlayer.addAttachment(plugin, name, value, ticks)

    override fun addAttachment(
        plugin: Plugin,
        ticks: Int
    ): PermissionAttachment? = wrapperPlayer.addAttachment(plugin, ticks)
    ...
    override fun <T : Projectile?> launchProjectile(
        ...
        velocity: Vector?
    ): T & Any = wrapperPlayer.launchProjectile(projectile, velocity)
    ...
    override fun sendPluginMessage(
        ...
        channel: String,
        message: ByteArray
    ) = wrapperPlayer.sendPluginMessage(source, channel, message)
